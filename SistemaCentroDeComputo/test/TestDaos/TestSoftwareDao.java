...
public class TestSoftwareDao {
  ...
  public void testObtenerListaSoftware() {
    ...
    final Date FECHAADQUISICION_OBTENIDO =
        listaSoftware.get(ELEMENTO_DELA_LISTA).getFechaAdquisicion();
    ...
    final boolean REQUIEREACTUALIZACION_OBTENIDO =
        listaSoftware.get(ELEMENTO_DELA_LISTA).isRequiereActualizacion();
    ...
    final String SISTEMAOPERATIVO_OBTENIDO =
        listaSoftware.get(ELEMENTO_DELA_LISTA).getSistemaOperativo();
    ...
    assertEquals("prueba id software", REQUIEREACTUALIZACION_ESPERADA,
        REQUIEREACTUALIZACION_OBTENIDO);
  ...
  public void testBuscarSoftware() {
    ...
    assertEquals("prueba observaciones del software", OBSERVACIONES_ESPERADAS,
        OBSERVACIONES_OBTENIDO);
    assertEquals("prueba fechaAdquis. del software", FECHAADQUISICION_ESPERADA,
        FECHAADQUISICION_OBTENIDO);
    ...
    assertEquals("prueba actualiacion del software", REQUIEREACTUALIZACION_ESPERADA,
        REQUIEREACTUALIZACION_OBTENIDO);
    ...
    assertEquals("prueba sistema operativo del software", SISTEMAOPERATIVO_ESPERADO,
        SISTEMAOPERATIVO_OBTENIDO);
