...
public class Usuario {
  ...
  public Usuario(String nombres, String apellido, String correoInstitucional, String contrasena,
      String rol, String estado, String numeroPersonal, String telefonoConExtension) {
    super();
